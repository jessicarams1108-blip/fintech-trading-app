...
import { availableBorrowUsd, COLLATERAL_FACTOR, effectiveMaxBorrowUsd, } from "../lib/borrowPolicy.js";
...
import { insertBorrowRequest, listBorrowRequestsForUser, sumPendingBorrowUsdForUser, } from "../db/queries/adminQueues.js";
...
borrowRouter.get("/power", limiter, async (req, res, next) => {
    try {
        ...
        const healthFactor = outstanding > 0.01 ? Math.round(((suppliedUsd * COLLATERAL_FACTOR) / outstanding) * 100) / 100 : 99.99;
