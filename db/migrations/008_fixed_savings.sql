...
VALUES
  ...
  ('a1000001-0001-4001-8001-000000000002', '30 - 59 Days', 15.000, 30, 59, 2000, 5000000, 'active', 2),
  ('a1000001-0001-4001-8001-000000000003', '60 - 89 Days', 20.000, 60, 89, 2000, 5000000, 'active', 3),
  ('a1000001-0001-4001-8001-000000000004', '90 - 179 Days', 25.000, 90, 179, 2000, 5000000, 'active', 4),
  ('a1000001-0001-4001-8001-000000000005', '180 - 364 Days', 30.000, 180, 364, 2000, 5000000, 'active', 5),
  ('a1000001-0001-4001-8001-000000000006', '365 - 1000 Days', 35.000, 365, 1000, 2000, 5000000, 'active', 6)
